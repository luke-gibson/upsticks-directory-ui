...
<template>
    <HeroComponent large="https://res.cloudinary.com/dqqarxqbu/image/upload/v1720099452/upsticks%20diredtory/desktop-home-page_drdhqe.jpg  " medium="https://res.cloudinary.com/dqqarxqbu/image/upload/v1720099452/upsticks%20diredtory/tablet-home-page_xfrd3l.jpg"
        ...
        <figcaption class="bg-[#2B5773] lg:pt-9 px-6 py-8 lg:pb-12 lg:px-9 max-w-screen-md mx-auto lg:rounded-lg lg:m-[-150px] relative">
    ...
    <div class="font-[sans-serif] lg:mt-[150px]">
