...
<template>
    <HeroComponent large="https://res.cloudinary.com/dqqarxqbu/image/upload/v1720099452/upsticks%20diredtory/desktop-home-page_drdhqe.jpg" medium="https://res.cloudinary.com/dqqarxqbu/image/upload/v1720099452/upsticks%20diredtory/tablet-home-page_xfrd3l.jpg"
        small="https://res.cloudinary.com/dqqarxqbu/image/upload/v1720099452/upsticks%20diredtory/mobile-home-page_crptxj.jpg">
        <figcaption class="bg-[#2B5773] lg:pt-9 px-6 py-8 lg:pb-12 lg:px-9 lg:max-w-screen-md mx-auto lg:rounded-lg mg:rounded-lg lg:mt-[-150px] relative">
            <div class="mx-auto text-center text-[#E2883C]">
                ...
                <div class="mt-10">
                    <input type="email" placeholder="Enter postcode, town or city" class="w-full sm:w-96 bg-gray-50 py-3.5 px-4 text-[#333] text-base focus:outline-none rounded" />
                    <button class="max-sm:mt-8 sm:ml-4 bg-[#E2883C] hover:bg-[#be7335] text-[#2B5773] text-base font-semibold py-3.5 px-6 rounded hover:shadow-md hover:transition-transform transition-transform hover:scale-105 focus:outline-none">
                            Search
                          </button>
                </div>
            </div>
    ...
    <section class="bg-[#f2f2f2]">
        <div class="md:container mx-auto py-16 px-4">
            <h2 class="text-gray-800 text-4xl font-extrabold text-center mb-4">Join upsticks directory</h2>
            <p class="text-gray-800 text-center mb-16">
                Join Upsticks Directory to connect with prospective buyers and grow your business today.
            </p>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-md:max-w-md mx-auto">
                <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                    <div class="p-8">
                        ...
                        <h3 class="text-gray-800 text-xl font-semibold mb-3">Estate Agents</h3>
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                    <div class="p-8">
                        ...
                        <h3 class="text-gray-800 text-xl font-semibold mb-3">Mortgage Brokers</h3>
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                    <div class="p-8">
                        ...
                        <h3 class="text-gray-800 text-xl font-semibold mb-3">Conveyancers</h3>
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                    <div class="p-8">
                        ...
                        <h3 class="text-gray-800 text-xl font-semibold mb-3">Removals</h3>
                        <p class="text-gray-500 text-sm leading-relaxed">Tailor our product to suit your needs Tailor our product to suit your needs.</p>
                    </div>
                </div>
