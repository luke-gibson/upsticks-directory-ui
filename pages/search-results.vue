...
<template>
  ...
  >
    <figcaption class="absolute z-10 top-1/2 transform translate-y-[-50%] left-2 right-2">
      <h1 class="text-3xl font-bold text-white">Search Results for PO7 5UY</h1>
    </figcaption>
  </HeroComponent>
  ...
  <section class="mx-auto py-16 px-4 flex flex-col bg-[#f2f2f2] min-h-[50vh]">
    <div class="md:container mx-auto flex flex-wrap items-start">
      <div class="w-full md:w-2/3-minus-2.5rem">
        <ResultComponent>
          <nuxt-img
            ...
            alt="Estate Agent"
          />
          <div class="flex flex-col justify-between p-0 mt-6 md:mt-0 md:p-10 leading-normal">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">
              Archold &amp; Edwards | Waterlooville
            </h5>
          ...
          <div class="flex flex-col w-full text-center pr-6">
            <NuxtLink
              to="/search-results"
        ...
        <ResultComponent>
          <nuxt-img
            class="object-cover rounded-t-lg w-full md:w-56 md:rounded-none md:rounded-s-lg md:min-w-44"
            src="https://pearsons.com/img/logo.png"
            alt="Estate Agent"
          />
          <div class="flex flex-col justify-between p0 md:p-10 mt-6 md:mt-0 leading-normal">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">
      ...
      <aside class="bg-white border rounded-lg shadow md:ml-10 p-6 w-full md:w-1/3">
